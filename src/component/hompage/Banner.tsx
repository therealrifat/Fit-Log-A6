  ...
  return (
    <div className="flex md:flex-row flex-col  items-center max-w-11/12 mx-auto bg-[#15171D] gap-20 p-15  mt-10 rounded-2xl">
      <div className="md:inline flex flex-col space-y-5 items-center md:items-start">
        ...
        <Link href={"#library"}>
          <button className="border bg-[#C2F800] py-2 md:px-4 px-2 rounded-lg text-black md:font-semibold md:text-md text-sm md:mx-0 cursor-pointer">BROWSE WORKOUTS</button>
        </Link>
      </div>
      <div>
        <Image
